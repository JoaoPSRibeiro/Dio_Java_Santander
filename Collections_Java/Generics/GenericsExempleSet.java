...
public class GenericsExempleSet {
    public static void main(String[] args) {
        ...
        conjuntoSemGenerics.add(10); // Per mite adicionar qualquer tipo de objeto

        // Exemplo com Generics
        Set<String> conjuntoGenerics = new HashSet<>(); // Veja que definimos o tipo de okbjeot que receberemos em nosso conjunto
        conjuntoGenerics.add("Elemento 1");
        conjuntoGenerics.add("Elemento 2");

        //Iterando sobre o conjunto com Genreics
